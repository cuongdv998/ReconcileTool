...
partial class GiamDinhControl
{
    ...
    private void InitializeComponent()
    {
        ...
        btnFirst.Cursor    = Cursors.Hand; btnFirst.FlatAppearance.BorderColor = Color.FromArgb(200, 210, 225);
        btnFirst.FlatStyle = FlatStyle.Flat; btnFirst.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
        btnFirst.ForeColor = Color.FromArgb(220, 95, 20); btnFirst.Location = new Point(12, 8);
        btnFirst.Name      = "btnFirst"; btnFirst.Size = new Size(36, 26); btnFirst.Text = "«";
        btnFirst.Click    += btnFirst_Click;

        btnPrev.Cursor    = Cursors.Hand; btnPrev.FlatAppearance.BorderColor = Color.FromArgb(200, 210, 225);
        btnPrev.FlatStyle = FlatStyle.Flat; btnPrev.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
        btnPrev.ForeColor = Color.FromArgb(220, 95, 20); btnPrev.Location = new Point(52, 8);
        btnPrev.Name      = "btnPrev"; btnPrev.Size = new Size(36, 26); btnPrev.Text = "‹";
        btnPrev.Click    += btnPrev_Click;

        lblPageInfo.Font      = new Font("Segoe UI", 9.5F); lblPageInfo.ForeColor = Color.FromArgb(50, 60, 75);
        lblPageInfo.Location  = new Point(94, 12); lblPageInfo.Name = "lblPageInfo";
        lblPageInfo.Size      = new Size(140, 18); lblPageInfo.TextAlign = ContentAlignment.MiddleCenter;

        btnNext.Cursor    = Cursors.Hand; btnNext.FlatAppearance.BorderColor = Color.FromArgb(200, 210, 225);
        btnNext.FlatStyle = FlatStyle.Flat; btnNext.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
        btnNext.ForeColor = Color.FromArgb(220, 95, 20); btnNext.Location = new Point(240, 8);
        btnNext.Name      = "btnNext"; btnNext.Size = new Size(36, 26); btnNext.Text = "›";
        btnNext.Click    += btnNext_Click;

        btnLast.Cursor    = Cursors.Hand; btnLast.FlatAppearance.BorderColor = Color.FromArgb(200, 210, 225);
        btnLast.FlatStyle = FlatStyle.Flat; btnLast.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
        btnLast.ForeColor = Color.FromArgb(220, 95, 20); btnLast.Location = new Point(280, 8);
        btnLast.Name      = "btnLast"; btnLast.Size = new Size(36, 26); btnLast.Text = "»";
        btnLast.Click    += btnLast_Click;

        lblPageSize.AutoSize  = true; lblPageSize.Font = new Font("Segoe UI", 9F);
        lblPageSize.ForeColor = Color.FromArgb(100, 110, 125); lblPageSize.Location = new Point(330, 13);
        lblPageSize.Name      = "lblPageSize"; lblPageSize.Text = "Hiển thị:";

        cboPageSize.DropDownStyle = ComboBoxStyle.DropDownList; cboPageSize.Font = new Font("Segoe UI", 9F);
        cboPageSize.Items.AddRange(new object[] { "20", "50", "100", "200", "500" });
        cboPageSize.Location = new Point(393, 9); cboPageSize.Name = "cboPageSize";
        cboPageSize.Size     = new Size(65, 23);
        cboPageSize.SelectedIndexChanged += cboPageSize_SelectedIndexChanged;

        lblTotalRecords.AutoSize  = true; lblTotalRecords.Font = new Font("Segoe UI", 9F);
